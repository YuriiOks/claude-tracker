// Mock data for Claude Code Tracker
// 4 active repos + global setup
...
const REPOS = [
  {
    ...
    accent: "#d97757",
    isActive: true, // currently has live session
    stats: {
      sessionsToday: 14,
      sessionsWeek: 73,
...
// Agent metadata — descriptions, file paths, delegation graph
const AGENT_META = {
  "jupus-orchestrator": {
    repo: "jupus",
...
// Live activity feed events (template — gets streamed live)
...
// Future events to stream in
const LIVE_EVENTS_FUTURE = [
...
// Real file sizes (bytes) parsed from ~/.claude tree — used to size graph nodes
const FILE_SIZES = {
  agents: {
    ...
    // voice / anita / mcp-presentation agents — estimated
