...
const Icon = ({ name, size = 14, ...rest }) => {
  const paths = {
    ...
    git: <><circle cx="6" cy="6" r="3"/><circle cx="18" cy="18" r="3"/><path d="M15.7 6H18a2 2 0 0 1 2 2v7.3"/></>,
    ...
    diff: <><circle cx="6" cy="6" r="3"/><circle cx="18" cy="18" r="3"/><path d="M11 6h7a2 2 0 0 1 2 2v7"/><path d="M13 18H6a2 2 0 0 1-2-2V9"/></>,
  };
  return (
