// Sessions log, Agents/skills page, Permissions, Plugins, Diff, Heatmap, Cost, Graph

const SessionsPage = ({ sessions, repos }) => {
...
const LivePage = ({ liveEvents, repos }) => (
  <>
...
const PermissionsPanel = ({ scope = 'all repos' }) => {
  const D = window.MOCK_DATA.PERMISSIONS_DETAIL;
  const Section = ({ title, items, badge, color, accent }) => (
    <div className="card-frame">
      <div className="card-frame-head">
